...
@Component({
  ...
  templateUrl: './paciente-atendimento-form.component.html',
  styleUrls: ['./paciente-atendimento-form.component.scss']
})
export class PacienteAtendimentoFormComponent extends BaseFormComponent implements OnInit {
    ...
    this.route.params.subscribe((params: any) => {
      ...
      if (idAtendimento) {
        ...
        atendimento$.subscribe(atendimento => {
          ...
          this.carregarDetalheAtendimento(atendimento);
  ...
  carregarDetalheAtendimento(atendimento){
  ...
  cancelar(){
    this.router.navigate(['/patient/atendimentos/lista'], { relativeTo: this.route });
  }
