...
@Component({
  selector: 'app-clinica-paciente-form',
  templateUrl: './clinica-paciente-form.component.html',
  styleUrls: ['./clinica-paciente-form.component.scss'],
  providers: [
    { provide: DateAdapter, useClass: AppDateAdapter },
    { provide: MAT_DATE_FORMATS, useValue: APP_DATE_FORMATS }
  ]
})
export class ClinicaPacienteFormComponent extends BaseFormComponent implements OnInit {
  ...
  cancelar() {
    this.router.navigate(['/clinic/pacientes/lista'], { relativeTo: this.route });
  }
