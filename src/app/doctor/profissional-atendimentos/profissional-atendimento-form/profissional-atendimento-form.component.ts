...
@Component({
  ...
  templateUrl: './profissional-atendimento-form.component.html',
  styleUrls: ['./profissional-atendimento-form.component.scss']
})
export class ProfissionalAtendimentoFormComponent extends BaseFormComponent implements OnInit {
  ...
  cancelar(){
    this.router.navigate(['/user/atendimentos/lista'], { relativeTo: this.route });
  }
