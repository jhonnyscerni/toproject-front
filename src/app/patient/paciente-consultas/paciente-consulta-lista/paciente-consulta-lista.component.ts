...
@Component({
  ...
  templateUrl: './paciente-consulta-lista.component.html',
  styleUrls: ['./paciente-consulta-lista.component.scss']
})
export class PacienteConsultaListaComponent implements OnInit {
  ...
  constructor(private router: Router,
    ...
    paciente = this.authService.getUsuarioIdAutenticado();
    ...
    onEdit(id) {
      this.router.navigate(['/patient/consultas/editar', id], { relativeTo: this.route });
    }

    onDetalhe(id) {
      this.router.navigate(['/patient/consultas/detalhe', id], { relativeTo: this.route });
    }
